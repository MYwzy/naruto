...
#总销售量
print("总销售量：",(63+45+129+63+58+48+63+120+43+25+43+60+43+78+60+
72+35+90+60+60+140+63+24+63+57+10+69+140+10+10))
#每个种类月销售量占比
#T恤销售量占比
print("T恤销售量占比：",((63+45+129+63+58+48+63)/1844)*100,"%")
#衬衫销售量占比
print("衬衫销售量占比：",(120/1844)*100,"%")
#风衣销售量占比
print("风衣销售量占比：",((43+25+43+60+43+78)/1844)*100,"%")
#牛仔裤销售量占比
print("牛仔裤销售量占比：",((60+72+35+90+60+60+140)/1844)*100,"%")
#皮草销售量占比
print("皮草销售量占比：",((63+24+63+57)/1844)*100,"%")
#羽绒服销售量占比
print("羽绒服销售量占比：",((10+69+140+10+10)/1844)*100,"%")